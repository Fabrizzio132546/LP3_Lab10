...
import java.net.URL; // Agregado para URL
...
public class MenuPrincipal extends JFrame {
    ...
    public MenuPrincipal() {
        ...
        try {
            ...
            URL urlLogo = getClass().getResource("/javatro/recursos/imagenes/titulo_balatro.png");
            if (urlLogo != null) {
                imagenLogo = ImageIO.read(urlLogo);
            } else {
                System.err.println(
                        "ERROR: No se encontró la imagen del logo en /javatro/recursos/imagenes/titulo_balatro.png");
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        // historial
        BotonBalatro btnHistory = new BotonBalatro("HISTORIAL", new Color(138, 43, 226)); // color morado
