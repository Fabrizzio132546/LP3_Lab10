...
import java.util.Random; // Import necesario
...
public class JuegoModelo {
    ...
    public void jugarMano(List<Carta> seleccionadas) {
        ...
        // mueve de mano jugador a cartas en mesa
        ...
        // notifica al jugador, le muestra la animacion, de cartas saltando y sumando puntos
        notificarCartas();
    ...
    public int getManosRestantes() { return manosRestantes; }
    public int getDescartesRestantes() { return descartesRestantes; }
    public List<Carta> getManoJugador() { return manoJugador; }
    public int getPuntajeAcumulado() { return puntajeAcumulado; }
    public int getPuntajeObjetivo() { return puntajeObjetivo; }
    public int getDinero() { return dinero; }
    public GestorJokers getGestorJokers() { return gestorJokers; }
    ...
    private void reconstruirEstrategia() {
    	//evalua reglas basicas del joker
        this.estrategiaPuntaje = new EvaluacionEstandar();
    ...
    public Carta agregarCartaAlMazo() {
        Palo[] palos = Palo.values();
        Valor[] valores = Valor.values();

        Random r = new Random();
        Carta nueva = new Carta(
                palos[r.nextInt(palos.length)],
                valores[r.nextInt(valores.length)]
        );
